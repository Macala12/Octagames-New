    ...
    n.m = e, n.g = function() {
        ...
        const W = async function r(o) {
            ...
            s.wbg.__wbg_newwithlength_929232475839a482 = function (e) {
                ...
                var r = g(y(i(n)), t.__wbindgen_malloc, t.__wbindgen_realloc), o = f;
                h()[e / 4 + 1] = o, h()[e / 4 + 0] = r;
        ...
        Q.install({ type: "application/futuresplash", description: "Shockwave Flash", suffixes: "spl", enabledPlugin: Q }), Q.install({ type: "application/x-shockwave-flash", description: "Shockwave Flash", suffixes: "swf", enabledPlugin: Q }), Q.install({ type: "application/x-shockwave-flash2-preview", description: "Shockwave Flash", suffixes: "swf", enabledPlugin: Q }), Q.install({ type: "application/vnd.adobe.flash-movie", description: "Shockwave Flash", suffixes: "swf", enabledPlugin: Q });
        ...
        function K(e, t) {
            ...
            if (void 0 !== window.customElements) for (; n < 999;) {
                let r = e;
                if (n > 0 && (r = r + "-" + n), void 0 === window.customElements.get(r)) return window.customElements.define(r, t), Z[e] = { class: t, name: r, internalName: e }, r;
                n += 1;
            }
            throw new Error("Failed to assign custom element " + e);
        }
        const ee = "application/x-shockwave-flash", te = "application/futuresplash", ne = "application/x-shockwave-flash2-preview", re = "application/vnd.adobe.flash-movie", ie = "https://ruffle.rs", oe = /^\s*(\d+(\.\d+)?(%)?)/;
        let ae = !1;
        function se(e) {
            if (null == e) return {};
        ...
        class ce extends HTMLElement {
            ...
            async downloadSwf() {
                try {
                    if (this.swfUrl) {
                        ...
                        const t = await e.blob(), n = URL.createObjectURL(t), r = document.createElement("a");
            ...
            contextMenuItems() {
                const e = String.fromCharCode(10003), t = [];
                ...
                })), this.instance && this.swfUrl && this.showSwfDownload && (t.push(null), t.push({ text: "Download .swf", onClick: this.downloadSwf.bind(this) })), t.push(null);
                const n = this.isExtension ? "extension" : "";
                return t.push({ text: `About Ruffle ${n} (nightly 2021-12-22)`, onClick() { window.open(ie, "_blank"); } }), this.isTouch && (t.push(null), t.push({ text: "Hide this menu", onClick: () => this.contextMenuForceDisabled = !0 })), t;
            }
            showContextMenu(e) {
                ...
                for (const e of this.contextMenuItems()) if (null === e) {
                    ...
                    const { text: t, onClick: n, enabled: r } = e, i = document.createElement("li");
                ...
                const t = this.getBoundingClientRect(), n = e.clientX - t.x, r = e.clientY - t.y, i = t.width - this.contextMenuElement.clientWidth - 1, o = t.height - this.contextMenuElement.clientHeight - 1;
            ...
            unmuteAudioContext() {
                ae || (navigator.maxTouchPoints < 1 ? ae = !0 : this.container.addEventListener("click", (() => {
                    ...
                    const n = new Audio;
                    n.src = (() => {
                        const e = new ArrayBuffer(10), n = new DataView(e), r = t.sampleRate;
            ...
            panic(e) {
                ...
                const n = null !== (t = null == e ? void 0 : e.ruffleIndexError) && void 0 !== t ? t : 0, r = Object.assign([], { stackIndex: -1 });
        ...
        class be extends ce {
            ...
            connectedCallback() {
                ...
                if (b) {
                    const d = null !== (t = null === (e = this.attributes.getNamedItem("allowScriptAccess")) || void 0 === e ? void 0 : e.value) && void 0 !== t ? t : null, g = null !== (r = null === (n = this.attributes.getNamedItem("menu")) || void 0 === n ? void 0 : n.value) && void 0 !== r ? r : null;
                    this.load({
                        url: b.value,
            ...
            attributeChangedCallback(e, t, n) {
                ...
                if (super.attributeChangedCallback(e, t, n), this.isConnected && "src" === e) {
                    ...
                    n && this.load({ url: n.value, parameters: e, base: null === (r = this.attributes.getNamedItem("base")) || void 0 === r ? void 0 : r.value });
                }
            }
            ...
            static fromNativeEmbedElement(e) {
                const t = K("ruffle-embed", be), n = document.createElement(t);
        ...
        function ge(e) {
            ...
            for (const i of e.children) if (i instanceof HTMLParamElement) {
                const e = null === (t = i.attributes.getNamedItem("name")) || void 0 === t ? void 0 : t.value, o = null === (n = i.attributes.getNamedItem("value")) || void 0 === n ? void 0 : n.value;
                e && o && (r[e] = o);
            }
            return r;
        }
        class we extends ce {
            ...
            connectedCallback() {
                ...
                const n = de(this.params, "allowScriptAccess", null), r = de(this.params, "flashvars", this.getAttribute("flashvars")), i = de(this.params, "bgcolor", this.getAttribute("bgcolor")), o = de(this.params, "base", this.getAttribute("base")), a = de(this.params, "menu", null), s = de(this.params, "salign", ""), c = de(this.params, "quality", "high"), u = de(this.params, "scale", "showAll");
                if (t) {
                    const e = { url: t };
            ...
            static isInterdictable(e) {
                ...
                const i = null === (t = e.attributes.getNamedItem("data")) || void 0 === t ? void 0 : t.value.toLowerCase(), o = ge(e);
                let a;
                if (i) a = _e(i);
                else {
            ...
            static fromNativeObjectElement(e) {
                const t = K("ruffle-object", we), n = document.createElement(t);
        ...
        var he, me;
        let pe;
        const ye = null !== (me = null === (he = window.RufflePlayer) || void 0 === he ? void 0 : he.config) && void 0 !== me ? me : {}, ve = q(ye) + "ruffle.js";
        let xe, ke, Ee, Ae;
        function Se() {
            try {
                xe = null != xe ? xe : document.getElementsByTagName("object"), ke = null != ke ? ke : document.getElementsByTagName("embed");
                for (const e of Array.from(xe)) if (we.isInterdictable(e)) {
                    const t = we.fromNativeObjectElement(e);
                    t.setIsExtension(pe), e.replaceWith(t);
                }
                for (const e of Array.from(ke)) if (be.isInterdictable(e)) {
        ...
        async function Ie(e, t) {
            ...
            if (pe || void 0 === r.documentElement.dataset.ruffleOptout) if (pe) e.RufflePlayer || (e.RufflePlayer = {}), e.RufflePlayer.config = Object.assign(Object.assign({}, ye), null !== (n = e.RufflePlayer.config) && void 0 !== n ? n : {});
        ...
        class Fe {
            ...
            static fromRequirementString(e) {
                ...
                let n = [];
                const r = [];
                for (let e = 0; e < t.length; e += 1) if ("||" === t[e]) n.length > 0 && (r.push(n), n = []);
        ...
        window.RufflePlayer = Te.negotiate(window.RufflePlayer, "local", new class {
            ...
            pluginPolyfill() {
                !function (e) {
                    "install" in navigator.plugins && navigator.plugins.install || Object.defineProperty(navigator, "plugins", { value: new J(navigator.plugins),writable:!1}),navigator.plugins.install(e),!(e.length>0)||"install"in navigator.mimeTypes&&navigator.mimeTypes.install||Object.defineProperty(navigator,"mimeTypes",{value:new G(navigator.mimeTypes),writable:!1});const t=navigator.mimeTypes;for(let n=0;n<e.length;n+=1)t.install(e[n])}(Q)}createPlayer(){const e=K("ruffle-player",ce);return document.createElement(e)}}("local"))})()})();
