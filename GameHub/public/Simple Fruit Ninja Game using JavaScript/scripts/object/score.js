...
exports.set = function() {
    ...
    image = layer.createImage("default", "images/score.png", 
        imageSx * scale.width, 8 * scale.height, 
        29 * scale.width, 31 * scale.height).hide();
    text1 = layer.createText("default", "0", 
        text1Sx * scale.width, 24 * scale.height, 
        "90-#fc7f0c-#ffec53", (30 * scale.height) + "px").hide();
    text2 = layer.createText("default", "BEST 999", 
        text2Sx * scale.width, 48 * scale.height, 
        "#af7c05", (14 * scale.height) + "px").hide();
};
